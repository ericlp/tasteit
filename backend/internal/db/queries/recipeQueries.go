...
var getRecipeByNameQuery = `SELECT id, name, unique_name, description, oven_temp, estimated_time, deleted, owned_by
FROM recipe
WHERE unique_name=$1`
...
var getRecipeByIdQuery = `SELECT id, name, unique_name, description, oven_temp, estimated_time, deleted, owned_by
FROM recipe
WHERE id=$1`
...
var getNonDeletedRecipesQuery = `SELECT id, name, unique_name, description, oven_temp, estimated_time, deleted, owned_by
FROM recipe
WHERE deleted=false`
...
SELECT recipe.id, name, unique_name, description, oven_temp, estimated_time, deleted, owned_by 
